    ...
    return (
        <main className="relative bg-black min-h-screen flex flex-col">
            ...
            <div
                ...
                style={{ paddingTop: 'calc(90px + 32px)' }}
            >
                <div
                    ...
                    style={{
                        ...
                        borderRadius: '20px',
                        boxShadow: '0 0 60px rgba(224,48,71, 0.15), 0 25px 80px rgba(0,0,0,0.6)',
                    }}
                >
                    {/* LEFT — Spline 3D Bot */}
                    <div
                        ...
                        style={{
                            minHeight: '220px',
                            background: 'radial-gradient(ellipse at center, rgba(224,48,71,0.08) 0%, transparent 70%)',
                        }}
                    >
                        <div
                            className="absolute inset-0 pointer-events-none"
                            style={{
                                background: 'radial-gradient(circle at 50% 50%, rgba(224,48,71,0.12) 0%, transparent 60%)',
                            }}
                        />
                        <Spline
                    ...
                    <div
                        ...
                        style={{
                            background: 'linear-gradient(to bottom, transparent, rgba(224,48,71,0.3), rgba(255,255,255,0.06), transparent)',
                        }}
                    />
                            ...
                            {chat.length === 0 && !isLoading && (
                                <div className="h-full flex items-center justify-center">
                                    <div className="text-center">
                                        ...
                                        <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.15)', maxWidth: '240px' }}>
                                            Ask about our web design, motion graphics, UI/UX or any of our services.
                                        </p>
                                    </div>
                                </div>
                            )}
                            ...
                            {chat.map((c, i) => (
                                <div key={i} className={`flex ${c.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                    <div
                                        ...
                                        style={{
                                            padding: '10px 12px',
                                            borderRadius: c.role === 'user' ? '16px 16px 4px 16px' : '16px 16px 16px 4px',
                                            background: c.role === 'user'
                                                ? 'linear-gradient(135deg, #e03047, #a00000)'
                                                : 'rgba(255,255,255,0.06)',
                                            color: c.role === 'user' ? '#fff' : 'rgba(255,255,255,0.85)',
                            ...
                            {isLoading && (
                                <div className="flex justify-start">
                                    <div
                                        ...
                                        style={{ borderRadius: '16px 16px 16px 4px', background: 'rgba(255,255,255,0.06)' }}
                                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <button
                                    ...
                                    style={{
                                        background: message.trim() && !isLoading ? '#e03047' : 'rgba(255,255,255,0.05)',
                                        color: message.trim() && !isLoading ? '#fff' : 'rgba(255,255,255,0.2)',
